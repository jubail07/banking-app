...
const { logout, getHomePage, accountOpeningForm, getPendingPage, getFormSubmissionPage, getTransaction, getUpi, upi, getPeople, getPayment, payment } = require('../controller/dashboard')
